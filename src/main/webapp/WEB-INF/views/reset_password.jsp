...
<script type="text/javascript">
	function checkForm(form) {
		...
		if(form.confirmPassword.value != form.password.value){
			alert("Please check password and Confirm password are same!");
			form.confirmPassword.focus();
			return false;
		}
...
<div id="body">
  ...
  <h2 class="module-title">Please Enter Your Password to Reset:</h2>
   <div class="article module-content">
    <form:form name="resetPasswordForm" action="${pageContext.request.contextPath}/portal/processresetpassword.html" method="post" modelAttribute="user" onsubmit="return checkForm(this);">
             <div id="frmdtdv">
             <div>
